...
plt.figure(figsize=(20,5))
plt.title('contraction signal', fontsize=10)
plt.subplot(2,2,1)
plt.plot(contract_t[0], contract_emg[0], linewidth=0.5, color = 'orange', label = 'contraction 1')
plt.xlabel('t(s)' , fontsize=10)
plt.ylabel('amplitude(μV)', fontsize=10)
plt.subplot(2,2,2)
plt.plot(contract_t[1], contract_emg[1], linewidth=0.5, color = 'orange', label = 'contraction 2')
plt.xlabel('t(s)' , fontsize=10)
plt.ylabel('amplitude(μV)', fontsize=10)
plt.subplot(2,2,3)
plt.plot(contract_t[2], contract_emg[2], linewidth=0.5, color = 'orange', label = 'contraction 3')
plt.xlabel('t(s)' , fontsize=10)
plt.ylabel('amplitude(μV)', fontsize=10)
plt.subplot(2,2,4)
plt.plot(contract_t[3], contract_emg[3], linewidth=0.5, color = 'orange', label = 'contraction 4')
plt.xlabel('t(s)' , fontsize=10)
plt.ylabel('amplitude(μV)', fontsize=10)
plt.show()
